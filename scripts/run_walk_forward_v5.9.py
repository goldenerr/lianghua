...
def main():
    ...
    with open(OUT_DIR/"wf_backtest_v5.9_report.json","w") as f:
        json.dump({"ts":datetime.now().isoformat(),"version":"V5.9",
    ...
    print(f"\n{'='*60}\n  V5.9 — n=35, 90d + Sector Cap (max {CONFIG['max_per_sector']}/industry)")
