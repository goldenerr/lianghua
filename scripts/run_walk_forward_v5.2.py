...
def main():
    ...
    with open(OUT_DIR/"wf_backtest_v5.2_report.json","w") as f:
        json.dump({"ts":datetime.now().isoformat(),"version":"V5.2","desc":"n=35 rebalance=90d V3.5 MR",
                   "cfg":CONFIG,"full":full,"wf":w,"gates":g,"elapsed":round(time.time()-t0,1)},f,indent=2,default=str)
    print(f"\n{'='*60}\n  V5.2 — n=35, rebalance=90d, V3.5 MR factors")
