#!/usr/bin/env python3
"""Research V13: V11 defensive overlay plus regime-gated industry rotation.

This candidate keeps V11's broader stock-level alpha in normal regimes and only
uses hard industry whitelisting in bear regimes. V12 improved WF decay but cut
too much exposure in normal markets; V13 tries to recover full-sample Sharpe
without reintroducing V11's weak-regime instability.
"""
...
def main() -> None:
    ...
    report = {
        ...
        "version": "V13-regime-industry-rotation",
        "research_only": True,
    ...
    out_path = RESULTS_DIR / "quant_logic_research_v13_regime_industry_rotation.json"
