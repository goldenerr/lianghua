...
"""
V5.5 — V5.2 base + Sector Diversification Constraint.
...
CONFIG = {
    ...
    # Sector constraints
    "max_per_sector": 3,  # max 5 stocks per industry
}
...
def main():
    ...
    with open(OUT_DIR/"wf_backtest_v5.5_report.json","w") as f:
        json.dump({"ts":datetime.now().isoformat(),"version":"V5.5",
    ...
    print(f"\n{'='*60}\n  V5.5 — n=35, 90d + Sector Cap (max {CONFIG['max_per_sector']}/industry)")
